            ...
            {busy ? (
              ...
              result.data.map((c) => (
                <tr key={c.id} className="group transition-colors hover:bg-gray-50/70">
                  ...
                  <td className="px-5 py-3.5 text-gray-600">{c.poRefNo}</td>
                  <td className="px-5 py-3.5 text-gray-600">{c.poDate.slice(0, 10)}</td>
                  <td className="px-5 py-3.5 text-right font-medium tabular-nums text-gray-800">{currency(contractTotal(c))}</td>
